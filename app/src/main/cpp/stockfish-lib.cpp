...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass clazz = jenv->FindClass("com/lazydroid/stockfishtest/StockfishService");
    if (clazz == 0) {
        LOGE("class com/lazydroid/stockfishtest/StockfishService not found");
    }
...
JNIEXPORT void JNICALL Java_com_lazydroid_stockfishtest_StockfishService_clientToEngine(JNIEnv *env,
                                                                                      jobject thiz,
                                                                                      jstring line) {
